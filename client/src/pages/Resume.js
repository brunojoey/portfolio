  ...
  return (
    <div>
      ...
      <div className="resume-links-div">
        ...
        |{" "}
        <a
          href="https://www.github.com/brunojoey"
          className="mx-3 resume-links"
        >
          Github
        </a>{" "}
      ...
      <p>
        {" "}
        An excellent communicator and collaborator that works well on team-based
      ...
      <p>
        <strong style={{ textDecoration: "underline" }}>Rizzy Home</strong>:
        Calhoun, GA | Social Media Manager &#38; Graphic Designer | 09/2018 –
        05/2019
      </p>
      <p>
        {" "}
        Consolidated over a hundred different inventory folders to delete
        unnecessary photos.{" "}
      </p>
      <p>
        {" "}
      ...
      <p>
        {" "}
        Created photos and designs to post through Adobe Creative Cloud.
        Co-designed and wireframed Rizzy Home’s 2019 Catalog while achieving a
        high satisfaction from my manager.{" "}
      </p>
      ...
      <p>
        ...
        : Nashville, TN | Full Stack Web Development Certificate | 2020
      </p>
      <p>
        Gained technical programming skills within HTML, CSS, JavaScript,
        Express.js, React.js, Node.js, and MySQL.{" "}
      </p>
      <p>
        <strong style={{ textDecoration: "underline" }}>
          The University of Tennessee at Chattanooga
        </strong>
        : Chattanooga, TN | Bachelors of Arts in Communications &#38; Spanish |
        2018
      </p>
    </div>
  );
