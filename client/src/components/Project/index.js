  ...
  return projects.map((project) => (
    <ContainerDiv className="card projectBody mb-3">
      ...
      <Row className="allWebImages mb-3">
        <Col s={4} m={6} lg={8}>
          <Image
            className={project.claNM}
            src={buildRoutes(project.image)}
            alt={project.alt}
          />
        </Col>
      </Row>
      ...
      <Row className="buttons">
        <Col s={4} m={6} lg={10}>
          <a href={project.deploy} className="btn btn-primary deploy mb-5">
            Check it Out
          </a>
          <a
            href={project.github}
            className="btn btn-primary githubProject ml-3 mb-5"
          >
            The Code
          </a>
        </Col>
